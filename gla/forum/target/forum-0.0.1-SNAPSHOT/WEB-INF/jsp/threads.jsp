				...
				<br clear="all" />
					...
					<table class="tablebg" cellspacing="1" width="100%">
						<tbody>
							...
							<tr>
								<td class="row1"><a class="topictitle">Mon fil de discussion</a></td>
								<td class="row2" align="center" width="130"><p class="topicauthor"><a class="username-coloured">Yves</a></p></td>
